...
- **`projects/gradle-completion-test-build/`** — Gradle project with 50+ malicious task names and descriptions (command substitution, variable expansion, process substitution, etc.) used by all test suites.
